...
TARGET_RELATION_OUT_DIR="${TARGET_RELATION_OUT_DIR:-$PWD/results/retain_anchored_context_head/mcf/seed1_target_relation_classifier_fix5_recognition}"

python scripts/mcf_target_relation_classifier_fix5_seed1.py \
