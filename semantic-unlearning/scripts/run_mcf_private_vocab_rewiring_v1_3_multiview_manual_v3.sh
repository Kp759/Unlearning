...
# V1.3 revision 3: leakage-safe multi-view training with same-relation
# protection_fit templates first, then constrained Base-model paraphrases.
# Seed 1 is development only.
