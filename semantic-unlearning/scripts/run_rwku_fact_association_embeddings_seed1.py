#!/usr/bin/env python3
"""Train the RWKU Batch-50 seed-1 fact-association residual bank."""
...
def main(argv=None):
    ...
    manifest = {
        ...
        "architecture": (
            "one independent residual vector per selected natural-input RWKU "
        ...
        "routing_policy": (
            "complete subject eligibility then nearest frozen layer-19 contextual key; "
            "all five subjects have multiple protected candidates"
        ),
    ...
    print(
        json.dumps(
            {
                "status": "rwku_fact_association_training_complete",
