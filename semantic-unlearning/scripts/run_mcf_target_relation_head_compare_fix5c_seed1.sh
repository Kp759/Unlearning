...
TARGET_RELATION_COMPARE_OUT_DIR="${TARGET_RELATION_COMPARE_OUT_DIR:-$PWD/results/retain_anchored_context_head/mcf/seed1_target_relation_head_compare_fix5c}"

python scripts/mcf_target_relation_head_compare_fix5c_seed1.py \
