...
printf '%s\n' \
  ...
  "utility_num=$UTILITY_NUM predictor hidden-state anchors" \
  "utility_seed=$UTILITY_SEED" \
  "utility_weight=$UTILITY_WEIGHT" \
  "utility_source=$WIKIDATA_DIR train records, excluding first $UTILITY_EXCLUDE_FIRST PPL source records"

python scripts/mcf_forget_only_active_repair_utility500_states.py \
...
print("\n" + "="*84)
print("MCF SEED 1 — BASELINE r8/m1 vs r8/m1 + 500 EXTERNAL UTILITY STATES")
print("="*84)
