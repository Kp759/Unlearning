#!/usr/bin/env python3
"""Train ZsRE seed-1 fact-association residuals with Router V2."""
...
METHOD_V2 = "fact_association_embeddings_zsre_router_v2"
...
def main(argv=None):
    ...
    manifest = {
        ...
        "architecture": (
            "50 independent fact-specific residual vectors; Router V2; frozen Llama; "
    ...
    print(json.dumps({
        "status": "zsre_fact_association_router_v2_training_complete",
