...
TARGET_REPRESENTATION_OUT_DIR="${TARGET_REPRESENTATION_OUT_DIR:-$PWD/results/retain_anchored_context_head/mcf/seed1_target_representation_compare_fix5e}"

python scripts/mcf_target_representation_compare_fix5e_seed1.py \
