...
if [[ $# -ne 2 ]]; then
  echo "Usage: $0 MODEL_PATH {preflight|prepare|train|verify}" >&2
  exit 2
fi
...
OUTPUT_ROOT="$ROOT/outputs/rwku_s5e600_rank0_nullrestore16"
MODEL_REVISION=0cb88a4f764b7a12671c53f0838cd831a0843b95

exec python "$SCRIPT_DIR/rwku_generated_s5e_rank0_nullrestore16.py" \
  --stage "$STAGE" \
