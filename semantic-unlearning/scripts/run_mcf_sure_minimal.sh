...
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/mcf_sure_minimal}"
...
# Architecture locks shared verbatim with the ZsRE runner.
...
echo "MCF minimal two-stage SURE complete: ${OUTPUT_ROOT}"
