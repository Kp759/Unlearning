...
# Revision 2 uses subject-aware answer-leak filtering when building synthetic
# training views.  All held-out/evaluation leakage barriers remain unchanged.
#
# LEAKAGE FIREWALL:
...
# Usage: bash scripts/run_mcf_private_vocab_rewiring_v1_3_multiview_manual_v2.sh OUTPUT_DIR
...
python -u scripts/build_mcf_private_vocab_rewiring_v1_3_training_views_v2.py \
