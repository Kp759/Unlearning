#!/usr/bin/env python3
"""No-model smoke tests for all-residual-row MQuAKE-style RWKU Stage 2."""
...
def main() -> None:
    cfg = experiment.load_configuration(
        ...
        / "config"
        / "rwku"
        / "directional_sure_mquake_stage2_all_residual_rows_seed0.json"
    )
    ...
    print("RWKU all-residual-row MQuAKE-style Stage2 smoke test PASS")
    ...
    print("  L2 LM head: DeltaW = C_F B_F, rank 4")
