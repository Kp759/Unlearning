...
# V1.3b revision 3: leakage-safe 10-view ablation with relation-anchored
# subject-slot generation.  Scientific change vs V1.3 remains ONLY 5 -> 10 views.
# Generation repair: missing views are generated around sanitized same-relation
# protection_fit direct templates instead of only the canonical forget wording.
...
python -u scripts/build_mcf_private_vocab_rewiring_v1_3_training_views_v5.py \
...
printf '\nV1.3b 10-view revision-3 experiment finished.\n'
