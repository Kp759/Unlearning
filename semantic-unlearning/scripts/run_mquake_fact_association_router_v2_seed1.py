#!/usr/bin/env python3
"""Train MQuAKE seed-1 fact-association residuals with Router V2."""
...
METHOD_V2 = "fact_association_embeddings_mquake_router_v2"
...
def main(argv=None):
    ...
    manifest = {
        ...
        "architecture": (
            "one independent residual vector per unique (subject, relation, target_true) association; Router V2; "
    ...
    print(
        json.dumps(
            {
                "status": "mquake_fact_association_router_v2_training_complete",
