...
echo "V3.4 is a preserved training-only rejection and cannot run from the V3.5.2 checkout." >&2
echo "Use run_mcf_embedding_keyed_neuron_v3_5_2_manual.sh with the preserved V3.2/V3.4/V3.5/V3.5.1 outputs." >&2
exit 2
