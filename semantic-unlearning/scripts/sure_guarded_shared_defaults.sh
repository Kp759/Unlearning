...
MIN_UTILITY_DOCUMENTS="${SURE_MIN_UTILITY_DOCUMENTS:-0}"
MIN_UTILITY_PROMPTS="${SURE_MIN_UTILITY_PROMPTS:-0}"
REQUIRED_UTILITY_CORPUS_PROTOCOL="${SURE_REQUIRED_UTILITY_CORPUS_PROTOCOL:-}"
...
STAGE2_CONSTRAINT_TOLERANCE="${SURE_STAGE2_CONSTRAINT_TOLERANCE:-1e-5}"
...
STAGE2_RESTARTS="${SURE_STAGE2_RESTARTS:-2}"
