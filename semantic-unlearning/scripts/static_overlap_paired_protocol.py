...
METHOD = "static_overlap_untied_paired_ga_gd_v3"
PLAN = {
    "steps": 100, "check_every": 5, "learning_rate": .003,
    "pair_batch": 8, "background_retain_batch": 32, "language_batch": 4,
    "retain_weight": .1, "kl_weight": 1., "background_weight": .25,
    "step_radius": .025, "backtracks": 10, "max_training_seconds": 1200,
    "max_stalled_steps": 20, "min_gate_nll_gain": .05, "stalled_gates": 6,
    "max_failed_preservation_gates": 6,
    ...
    "objective": "conflict_projected_capped_forget_ga_plus_hinged_companion_gd_and_base_kl",
    "training_preservation_failure": "restore_last_full_training_preservation_pass_add_worst_anchors_and_reset_optimizer",
}
