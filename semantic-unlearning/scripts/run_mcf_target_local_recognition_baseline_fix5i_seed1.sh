...
TARGET_LOCAL_OUT_DIR="${TARGET_LOCAL_OUT_DIR:-$PWD/results/retain_anchored_context_head/mcf/seed1_target_local_recognition_fix5i}"

python scripts/mcf_target_local_recognition_baseline_fix5i_seed1.py \
