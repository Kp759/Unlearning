#!/usr/bin/env python3
"""Run final-layer token-protected activation rewiring."""
from run_static_overlap_endpoint_ga import main as run
from static_overlap_activation_protocol_v7 import METHOD, PLAN, load_pilot
...
def editor_factory(model, mask):
    ...
    return ActivationRewireEditor(model, [layers[-1]], PLAN["activation_key_rank"])
