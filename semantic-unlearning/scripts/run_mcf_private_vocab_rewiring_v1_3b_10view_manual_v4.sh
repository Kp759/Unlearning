...
# V1.3b revision 4: 10-view ablation with conservative relation-anchored
# micro-paraphrase generation. Scientific gates and downstream worst-1
# optimization are unchanged. Seed 1 remains development only.
...
python -u scripts/build_mcf_private_vocab_rewiring_v1_3_training_views_v6.py \
...
printf '\nV1.3b 10-view revision-4 experiment finished.\n'
