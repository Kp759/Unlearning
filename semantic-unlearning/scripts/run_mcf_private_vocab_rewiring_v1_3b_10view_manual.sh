...
# V1.3b: leakage-safe 10-view ablation.
# Change from V1.3 revision 3: 1 canonical + 9 additional training views.
# Worst-1 objective, architecture, semantic filters, retain objective, and
# leakage firewall are unchanged. Seed 1 remains development only.
...
python -u scripts/build_mcf_private_vocab_rewiring_v1_3_training_views_v3.py \
...
printf '\nV1.3b 10-view experiment finished.\n'
